...
func initFixture(tb testing.TB) *fixture {
	tb.Helper()
	sdk.GetConfig().SetBech32PrefixForAccount("vvtx", "vvtx")
	...
	accountKeeper := authkeeper.NewAccountKeeper(
		...
		maccPerms,
		addresscodec.NewBech32Codec("vvtx"),
