...
func (s *IntegrationTestSuite) testAcl() {
	...
	// Init ACL module
	s.execInitAcl(s.chainA, 0, superAdmin.String(), superAdmin.String(), vvtxHomePath, fees.String())
	...
	s.execAddAclAdmin(s.chainA, 0, admin1.String(), superAdmin.String(), vvtxHomePath, fees.String())
	...
	s.execAddAclAdmin(s.chainA, 0, admin2.String(), superAdmin.String(), vvtxHomePath, fees.String())
	...
	s.execAddAclAdmin(s.chainA, 0, admin3.String(), superAdmin.String(), vvtxHomePath, fees.String())
	...
	// Delete admin3
	s.execDeleteAclAdmin(s.chainA, 0, admin3.String(), superAdmin.String(), vvtxHomePath, fees.String())
	...
	s.execAddAclAuthority(s.chainA, 0, superAdmin.String(), "Alice", accessDefinitions, admin1.String(), vvtxHomePath, fees.String())
	...
	s.execAddAclAuthority(s.chainA, 0, admin2.String(), "Bob", accessDefinitions, admin1.String(), vvtxHomePath, fees.String())
	...
	s.execAddAclAuthority(s.chainA, 0, admin3.String(), "Carol", accessDefinitions, admin1.String(), vvtxHomePath, fees.String())
	...
	s.execDeleteAclAuthority(s.chainA, 0, admin3.String(), admin1.String(), vvtxHomePath, fees.String())
	...
	s.execUpdateAclAuthority(s.chainA, 0, superAdmin.String(), "acl", updateAccessDefinitions, admin1.String(), vvtxHomePath, fees.String())
