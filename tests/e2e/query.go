...
func querySuperAdmin(endpoint string) (acltypes.QueryGetSuperAdminResponse, error) {
	...
	body, err := httpGet(fmt.Sprintf("%s/GGEZLabs/vvtxchain/acl/super_admin", endpoint))
	if err != nil {
		return res, err
	}
...
func queryAllAclAdmin(endpoint string) (acltypes.QueryAllAclAdminResponse, error) {
	...
	body, err := httpGet(fmt.Sprintf("%s/GGEZLabs/vvtxchain/acl/acl_admin", endpoint))
	if err != nil {
		return res, err
	}
...
func queryAclAdmin(endpoint, address string) (acltypes.QueryGetAclAdminResponse, error) {
	...
	body, err := httpGet(fmt.Sprintf("%s/GGEZLabs/vvtxchain/acl/acl_admin/%s", endpoint, address))
	if err != nil {
		return res, err
	}
...
func queryAllAclAuthority(endpoint string) (acltypes.QueryAllAclAuthorityResponse, error) {
	...
	body, err := httpGet(fmt.Sprintf("%s/GGEZLabs/vvtxchain/acl/acl_authority", endpoint))
	if err != nil {
		return res, err
	}
...
func queryAclAuthority(endpoint, address string) (acltypes.QueryGetAclAuthorityResponse, error) {
	...
	body, err := httpGet(fmt.Sprintf("%s/GGEZLabs/vvtxchain/acl/acl_authority/%s", endpoint, address))
	if err != nil {
		return res, err
	}
...
func queryAllStoredTrade(endpoint string) (tradetypes.QueryAllStoredTradeResponse, error) {
	...
	body, err := httpGet(fmt.Sprintf("%s/GGEZLabs/vvtxchain/trade/stored_trade", endpoint))
	if err != nil {
		return res, err
	}
...
func queryStoredTrade(endpoint, tradeIndex string) (tradetypes.QueryGetStoredTradeResponse, error) {
	...
	body, err := httpGet(fmt.Sprintf("%s/GGEZLabs/vvtxchain/trade/stored_trade/%s", endpoint, tradeIndex))
	if err != nil {
		return res, err
	}
...
func queryAllStoredTempTrade(endpoint string) (tradetypes.QueryAllStoredTempTradeResponse, error) {
	...
	body, err := httpGet(fmt.Sprintf("%s/GGEZLabs/vvtxchain/trade/stored_temp_trade", endpoint))
	if err != nil {
		return res, err
	}
...
func queryStoredTempTrade(endpoint, tradeIndex string) (tradetypes.QueryGetStoredTempTradeResponse, error) {
	...
	body, err := httpGet(fmt.Sprintf("%s/GGEZLabs/vvtxchain/trade/stored_temp_trade/%s", endpoint, tradeIndex))
	if err != nil {
		return res, err
	}
