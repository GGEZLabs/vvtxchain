...
func init() {
	...
	md_ExchangeRateJson = File_vvtxchain_trade_trade_proto.Messages().ByName("ExchangeRateJson")
...
func (x *ExchangeRateJson) slowProtoReflect() protoreflect.Message {
	mi := &file_vvtxchain_trade_trade_proto_msgTypes[0]
...
func (x *fastReflection_ExchangeRateJson) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vvtxchain.trade.ExchangeRateJson.from_currency":
		return x.FromCurrency != ""
	case "vvtxchain.trade.ExchangeRateJson.to_currency":
		return x.ToCurrency != ""
	case "vvtxchain.trade.ExchangeRateJson.original_amount":
		return x.OriginalAmount != float64(0) || math.Signbit(x.OriginalAmount)
	case "vvtxchain.trade.ExchangeRateJson.converted_amount":
		return x.ConvertedAmount != float64(0) || math.Signbit(x.ConvertedAmount)
	case "vvtxchain.trade.ExchangeRateJson.currency_rate":
		return x.CurrencyRate != float64(0) || math.Signbit(x.CurrencyRate)
	case "vvtxchain.trade.ExchangeRateJson.timestamp":
		return x.Timestamp != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.ExchangeRateJson"))
		}
		panic(fmt.Errorf("message vvtxchain.trade.ExchangeRateJson does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ExchangeRateJson) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vvtxchain.trade.ExchangeRateJson does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ExchangeRateJson) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vvtxchain.trade.ExchangeRateJson.from_currency":
		panic(fmt.Errorf("field from_currency of message vvtxchain.trade.ExchangeRateJson is not mutable"))
	case "vvtxchain.trade.ExchangeRateJson.to_currency":
		panic(fmt.Errorf("field to_currency of message vvtxchain.trade.ExchangeRateJson is not mutable"))
	case "vvtxchain.trade.ExchangeRateJson.original_amount":
		panic(fmt.Errorf("field original_amount of message vvtxchain.trade.ExchangeRateJson is not mutable"))
	case "vvtxchain.trade.ExchangeRateJson.converted_amount":
		panic(fmt.Errorf("field converted_amount of message vvtxchain.trade.ExchangeRateJson is not mutable"))
	case "vvtxchain.trade.ExchangeRateJson.currency_rate":
		panic(fmt.Errorf("field currency_rate of message vvtxchain.trade.ExchangeRateJson is not mutable"))
	case "vvtxchain.trade.ExchangeRateJson.timestamp":
		panic(fmt.Errorf("field timestamp of message vvtxchain.trade.ExchangeRateJson is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.ExchangeRateJson"))
		}
...
func (x *fastReflection_ExchangeRateJson) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vvtxchain.trade.ExchangeRateJson", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_vvtxchain_trade_trade_proto_init()
	md_CoinMintingPriceJson = File_vvtxchain_trade_trade_proto.Messages().ByName("CoinMintingPriceJson")
...
func (x *CoinMintingPriceJson) slowProtoReflect() protoreflect.Message {
	mi := &file_vvtxchain_trade_trade_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CoinMintingPriceJson) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vvtxchain.trade.CoinMintingPriceJson.currency_code":
		return x.CurrencyCode != ""
	case "vvtxchain.trade.CoinMintingPriceJson.minting_price":
		return x.MintingPrice != float64(0) || math.Signbit(x.MintingPrice)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.CoinMintingPriceJson"))
		}
		panic(fmt.Errorf("message vvtxchain.trade.CoinMintingPriceJson does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CoinMintingPriceJson) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vvtxchain.trade.CoinMintingPriceJson does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CoinMintingPriceJson) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vvtxchain.trade.CoinMintingPriceJson.currency_code":
		panic(fmt.Errorf("field currency_code of message vvtxchain.trade.CoinMintingPriceJson is not mutable"))
	case "vvtxchain.trade.CoinMintingPriceJson.minting_price":
		panic(fmt.Errorf("field minting_price of message vvtxchain.trade.CoinMintingPriceJson is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.CoinMintingPriceJson"))
		}
...
func (x *fastReflection_CoinMintingPriceJson) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vvtxchain.trade.CoinMintingPriceJson", d.FullName()))
	}
	panic("unreachable")
}
...
func (TradeStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_vvtxchain_trade_trade_proto_enumTypes[0].Descriptor()
}

func (TradeStatus) Type() protoreflect.EnumType {
	return &file_vvtxchain_trade_trade_proto_enumTypes[0]
}
...
func (TradeStatus) EnumDescriptor() ([]byte, []int) {
	return file_vvtxchain_trade_trade_proto_rawDescGZIP(), []int{0}
}
...
func (ProcessType) Descriptor() protoreflect.EnumDescriptor {
	return file_vvtxchain_trade_trade_proto_enumTypes[1].Descriptor()
}

func (ProcessType) Type() protoreflect.EnumType {
	return &file_vvtxchain_trade_trade_proto_enumTypes[1]
}
...
func (ProcessType) EnumDescriptor() ([]byte, []int) {
	return file_vvtxchain_trade_trade_proto_rawDescGZIP(), []int{1}
}
...
func (TradeType) Descriptor() protoreflect.EnumDescriptor {
	return file_vvtxchain_trade_trade_proto_enumTypes[2].Descriptor()
}

func (TradeType) Type() protoreflect.EnumType {
	return &file_vvtxchain_trade_trade_proto_enumTypes[2]
}
...
func (TradeType) EnumDescriptor() ([]byte, []int) {
	return file_vvtxchain_trade_trade_proto_rawDescGZIP(), []int{2}
}
...
var File_vvtxchain_trade_trade_proto protoreflect.FileDescriptor

var file_vvtxchain_trade_trade_proto_rawDesc = []byte{
	...
	0x45, 0x43, 0x54, 0x10, 0x02, 0x2a, 0xde, 0x01, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x64, 0x65, 0x54,
	...
	0x53, 0x10, 0x06, 0x12, 0x21, 0x0a, 0x1d, 0x54, 0x52, 0x41, 0x44, 0x45, 0x5f, 0x54, 0x59, 0x50,
	0x45, 0x5f, 0x44, 0x49, 0x56, 0x49, 0x44, 0x45, 0x4e, 0x44, 0x5f, 0x44, 0x45, 0x44, 0x55, 0x43,
	0x54, 0x49, 0x4f, 0x4e, 0x10, 0x07, 0x42, 0xb1, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
	0x67, 0x65, 0x7a, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x74, 0x72, 0x61, 0x64, 0x65, 0x42, 0x0a,
	0x54, 0x72, 0x61, 0x64, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x31, 0x67, 0x69,
...
var (
	file_vvtxchain_trade_trade_proto_rawDescOnce sync.Once
	file_vvtxchain_trade_trade_proto_rawDescData = file_vvtxchain_trade_trade_proto_rawDesc
)

func file_vvtxchain_trade_trade_proto_rawDescGZIP() []byte {
	file_vvtxchain_trade_trade_proto_rawDescOnce.Do(func() {
		file_vvtxchain_trade_trade_proto_rawDescData = protoimpl.X.CompressGZIP(file_vvtxchain_trade_trade_proto_rawDescData)
	})
	return file_vvtxchain_trade_trade_proto_rawDescData
}

var file_vvtxchain_trade_trade_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_vvtxchain_trade_trade_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_vvtxchain_trade_trade_proto_goTypes = []interface{}{
	(TradeStatus)(0),             // 0: vvtxchain.trade.TradeStatus
	(ProcessType)(0),             // 1: vvtxchain.trade.ProcessType
	(TradeType)(0),               // 2: vvtxchain.trade.TradeType
	(*ExchangeRateJson)(nil),     // 3: vvtxchain.trade.ExchangeRateJson
	(*CoinMintingPriceJson)(nil), // 4: vvtxchain.trade.CoinMintingPriceJson
}
var file_vvtxchain_trade_trade_proto_depIdxs = []int32{
...
func init() { file_vvtxchain_trade_trade_proto_init() }
func file_vvtxchain_trade_trade_proto_init() {
	if File_vvtxchain_trade_trade_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_vvtxchain_trade_trade_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vvtxchain_trade_trade_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vvtxchain_trade_trade_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vvtxchain_trade_trade_proto_goTypes,
		DependencyIndexes: file_vvtxchain_trade_trade_proto_depIdxs,
		EnumInfos:         file_vvtxchain_trade_trade_proto_enumTypes,
		MessageInfos:      file_vvtxchain_trade_trade_proto_msgTypes,
	}.Build()
	File_vvtxchain_trade_trade_proto = out.File
	file_vvtxchain_trade_trade_proto_rawDesc = nil
	file_vvtxchain_trade_trade_proto_goTypes = nil
	file_vvtxchain_trade_trade_proto_depIdxs = nil
}
