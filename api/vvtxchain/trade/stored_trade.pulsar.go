...
var (
	...
	fd_StoredTrade_tx_date                 protoreflect.FieldDescriptor
...
func init() {
	...
	md_StoredTrade = File_vvtxchain_trade_stored_trade_proto.Messages().ByName("StoredTrade")
	...
	fd_StoredTrade_tx_date = md_StoredTrade.Fields().ByName("tx_date")
...
func (x *StoredTrade) slowProtoReflect() protoreflect.Message {
	mi := &file_vvtxchain_trade_stored_trade_proto_msgTypes[0]
...
func (x *fastReflection_StoredTrade) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TxDate != "" {
		value := protoreflect.ValueOfString(x.TxDate)
		if !f(fd_StoredTrade_tx_date, value) {
			return
		}
	}
	if x.CreateDate != "" {
...
func (x *fastReflection_StoredTrade) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vvtxchain.trade.StoredTrade.trade_index":
	...
	case "vvtxchain.trade.StoredTrade.status":
		return x.Status != 0
	case "vvtxchain.trade.StoredTrade.maker":
		return x.Maker != ""
	case "vvtxchain.trade.StoredTrade.checker":
		return x.Checker != ""
	case "vvtxchain.trade.StoredTrade.tx_date":
		return x.TxDate != ""
	case "vvtxchain.trade.StoredTrade.create_date":
		return x.CreateDate != ""
	case "vvtxchain.trade.StoredTrade.update_date":
		return x.UpdateDate != ""
	case "vvtxchain.trade.StoredTrade.process_date":
		return x.ProcessDate != ""
	case "vvtxchain.trade.StoredTrade.trade_data":
		return x.TradeData != ""
	case "vvtxchain.trade.StoredTrade.coin_minting_price_json":
		return x.CoinMintingPriceJson != ""
	case "vvtxchain.trade.StoredTrade.exchange_rate_json":
		return x.ExchangeRateJson != ""
	case "vvtxchain.trade.StoredTrade.banking_system_data":
		return x.BankingSystemData != ""
	case "vvtxchain.trade.StoredTrade.result":
		return x.Result != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.StoredTrade"))
		}
		panic(fmt.Errorf("message vvtxchain.trade.StoredTrade does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StoredTrade) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vvtxchain.trade.StoredTrade does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StoredTrade) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "vvtxchain.trade.StoredTrade.tx_date":
		x.TxDate = value.Interface().(string)
	case "vvtxchain.trade.StoredTrade.create_date":
...
func (x *fastReflection_StoredTrade) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "vvtxchain.trade.StoredTrade.status":
		panic(fmt.Errorf("field status of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.maker":
		panic(fmt.Errorf("field maker of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.checker":
		panic(fmt.Errorf("field checker of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.tx_date":
		panic(fmt.Errorf("field tx_date of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.create_date":
		panic(fmt.Errorf("field create_date of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.update_date":
		panic(fmt.Errorf("field update_date of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.process_date":
		panic(fmt.Errorf("field process_date of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.trade_data":
		panic(fmt.Errorf("field trade_data of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.coin_minting_price_json":
		panic(fmt.Errorf("field coin_minting_price_json of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.exchange_rate_json":
		panic(fmt.Errorf("field exchange_rate_json of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.banking_system_data":
		panic(fmt.Errorf("field banking_system_data of message vvtxchain.trade.StoredTrade is not mutable"))
	case "vvtxchain.trade.StoredTrade.result":
		panic(fmt.Errorf("field result of message vvtxchain.trade.StoredTrade is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.StoredTrade"))
		}
...
func (x *fastReflection_StoredTrade) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vvtxchain.trade.StoredTrade", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_StoredTrade) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.TxDate) > 0 {
			i -= len(x.TxDate)
			copy(dAtA[i:], x.TxDate)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TxDate)))
			i--
			dAtA[i] = 0x4a
		}
		if len(x.Checker) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 9:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TxDate", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TxDate = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 10:
				if wireType != 2 {
...
func (*StoredTrade) Descriptor() ([]byte, []int) {
	return file_vvtxchain_trade_stored_trade_proto_rawDescGZIP(), []int{0}
}
...
func (x *StoredTrade) GetTxDate() string {
	if x != nil {
		return x.TxDate
	}
	return ""
...
var File_vvtxchain_trade_stored_trade_proto protoreflect.FileDescriptor

var file_vvtxchain_trade_stored_trade_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xac, 0x05, 0x0a, 0x0b, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x54, 0x72, 0x61,
	...
	0x74, 0x12, 0x33, 0x0a, 0x16, 0x63, 0x6f, 0x69, 0x6e, 0x5f, 0x6d, 0x69, 0x6e, 0x74, 0x69, 0x6e,
	0x67, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f, 0x75, 0x73, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x13, 0x63, 0x6f, 0x69, 0x6e, 0x4d, 0x69, 0x6e, 0x74, 0x69, 0x6e, 0x67, 0x50, 0x72,
	0x69, 0x63, 0x65, 0x55, 0x73, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76,
	...
	0x0e, 0x32, 0x1c, 0x2e, 0x67, 0x67, 0x65, 0x7a, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x74, 0x72,
	0x61, 0x64, 0x65, 0x2e, 0x54, 0x72, 0x61, 0x64, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x61, 0x6b, 0x65, 0x72,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x61, 0x6b, 0x65, 0x72, 0x12, 0x18, 0x0a,
	0x07, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x78, 0x5f, 0x64, 0x61,
	0x74, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x78, 0x44, 0x61, 0x74, 0x65,
	...
	,
	...
	0x74, 0x42, 0xb7, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x67, 0x65, 0x7a, 0x63, 0x68,
	0x61, 0x69, 0x6e, 0x2e, 0x74, 0x72, 0x61, 0x64, 0x65, 0x42, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x65,
	0x64, 0x54, 0x72, 0x61, 0x64, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x31, 0x67,
...
var (
	file_vvtxchain_trade_stored_trade_proto_rawDescOnce sync.Once
	file_vvtxchain_trade_stored_trade_proto_rawDescData = file_vvtxchain_trade_stored_trade_proto_rawDesc
)

func file_vvtxchain_trade_stored_trade_proto_rawDescGZIP() []byte {
	file_vvtxchain_trade_stored_trade_proto_rawDescOnce.Do(func() {
		file_vvtxchain_trade_stored_trade_proto_rawDescData = protoimpl.X.CompressGZIP(file_vvtxchain_trade_stored_trade_proto_rawDescData)
	})
	return file_vvtxchain_trade_stored_trade_proto_rawDescData
}

var file_vvtxchain_trade_stored_trade_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_vvtxchain_trade_stored_trade_proto_goTypes = []interface{}{
	(*StoredTrade)(nil),  // 0: vvtxchain.trade.StoredTrade
	(TradeType)(0),       // 1: vvtxchain.trade.TradeType
	(*v1beta1.Coin)(nil), // 2: cosmos.base.v1beta1.Coin
	(TradeStatus)(0),     // 3: vvtxchain.trade.TradeStatus
}
var file_vvtxchain_trade_stored_trade_proto_depIdxs = []int32{
	1, // 0: vvtxchain.trade.StoredTrade.trade_type:type_name -> vvtxchain.trade.TradeType
	2, // 1: vvtxchain.trade.StoredTrade.amount:type_name -> cosmos.base.v1beta1.Coin
	3, // 2: vvtxchain.trade.StoredTrade.status:type_name -> vvtxchain.trade.TradeStatus
...
func init() { file_vvtxchain_trade_stored_trade_proto_init() }
func file_vvtxchain_trade_stored_trade_proto_init() {
	if File_vvtxchain_trade_stored_trade_proto != nil {
		return
	}
	file_vvtxchain_trade_trade_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_vvtxchain_trade_stored_trade_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vvtxchain_trade_stored_trade_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vvtxchain_trade_stored_trade_proto_goTypes,
		DependencyIndexes: file_vvtxchain_trade_stored_trade_proto_depIdxs,
		MessageInfos:      file_vvtxchain_trade_stored_trade_proto_msgTypes,
	}.Build()
	File_vvtxchain_trade_stored_trade_proto = out.File
	file_vvtxchain_trade_stored_trade_proto_rawDesc = nil
	file_vvtxchain_trade_stored_trade_proto_goTypes = nil
	file_vvtxchain_trade_stored_trade_proto_depIdxs = nil
}
