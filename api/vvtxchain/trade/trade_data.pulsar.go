...
func init() {
	file_vvtxchain_trade_trade_data_proto_init()
	md_TradeData = File_vvtxchain_trade_trade_data_proto.Messages().ByName("TradeData")
...
func (x *TradeData) slowProtoReflect() protoreflect.Message {
	mi := &file_vvtxchain_trade_trade_data_proto_msgTypes[0]
...
func (x *fastReflection_TradeData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vvtxchain.trade.TradeData.trade_info":
		return x.TradeInfo != nil
	case "vvtxchain.trade.TradeData.brokerage":
		return x.Brokerage != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.TradeData"))
		}
		panic(fmt.Errorf("message vvtxchain.trade.TradeData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TradeData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vvtxchain.trade.TradeData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TradeData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vvtxchain.trade.TradeData", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_TradeInfo_share_net_price        protoreflect.FieldDescriptor
	fd_TradeInfo_trade_net_value        protoreflect.FieldDescriptor
)

func init() {
	file_vvtxchain_trade_trade_data_proto_init()
	md_TradeInfo = File_vvtxchain_trade_trade_data_proto.Messages().ByName("TradeInfo")
	...
	fd_TradeInfo_share_net_price = md_TradeInfo.Fields().ByName("share_net_price")
...
func (x *TradeInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_vvtxchain_trade_trade_data_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_TradeInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.NumberOfShares != float64(0) || math.Signbit(x.NumberOfShares) {
		value := protoreflect.ValueOfFloat64(x.NumberOfShares)
		if !f(fd_TradeInfo_number_of_shares, value) {
			return
		}
	}
	...
	if x.Quantity != nil {
		value := protoreflect.ValueOfMessage(x.Quantity.ProtoReflect())
	...
	if x.ShareNetPrice != float64(0) || math.Signbit(x.ShareNetPrice) {
		value := protoreflect.ValueOfFloat64(x.ShareNetPrice)
		if !f(fd_TradeInfo_share_net_price, value) {
			return
		}
	}
...
func (x *fastReflection_TradeInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vvtxchain.trade.TradeInfo.asset_holder_id":
		return x.AssetHolderId != uint64(0)
	case "vvtxchain.trade.TradeInfo.asset_id":
		return x.AssetId != uint64(0)
	case "vvtxchain.trade.TradeInfo.trade_type":
		return x.TradeType != 0
	case "vvtxchain.trade.TradeInfo.trade_value":
		return x.TradeValue != float64(0) || math.Signbit(x.TradeValue)
	case "vvtxchain.trade.TradeInfo.base_currency":
		return x.BaseCurrency != ""
	case "vvtxchain.trade.TradeInfo.settlement_currency":
		return x.SettlementCurrency != ""
	case "vvtxchain.trade.TradeInfo.exchange_rate":
		return x.ExchangeRate != float64(0) || math.Signbit(x.ExchangeRate)
	case "vvtxchain.trade.TradeInfo.exchange":
		return x.Exchange != ""
	case "vvtxchain.trade.TradeInfo.fund_name":
		return x.FundName != ""
	case "vvtxchain.trade.TradeInfo.issuer":
		return x.Issuer != ""
	...
	case "vvtxchain.trade.TradeInfo.ticker":
		return x.Ticker != ""
	case "vvtxchain.trade.TradeInfo.trade_fee":
		return x.TradeFee != float64(0) || math.Signbit(x.TradeFee)
	case "vvtxchain.trade.TradeInfo.share_net_price":
		return x.ShareNetPrice != float64(0) || math.Signbit(x.ShareNetPrice)
	case "vvtxchain.trade.TradeInfo.trade_net_value":
		return x.TradeNetValue != float64(0) || math.Signbit(x.TradeNetValue)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.TradeInfo"))
		}
		panic(fmt.Errorf("message vvtxchain.trade.TradeInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TradeInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vvtxchain.trade.TradeInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TradeInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "vvtxchain.trade.TradeInfo.quantity":
		if x.Quantity == nil {
			x.Quantity = new(v1beta1.Coin)
		}
		return protoreflect.ValueOfMessage(x.Quantity.ProtoReflect())
	case "vvtxchain.trade.TradeInfo.asset_holder_id":
		panic(fmt.Errorf("field asset_holder_id of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.asset_id":
		panic(fmt.Errorf("field asset_id of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.trade_type":
		panic(fmt.Errorf("field trade_type of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.trade_value":
		panic(fmt.Errorf("field trade_value of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.base_currency":
		panic(fmt.Errorf("field base_currency of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.settlement_currency":
		panic(fmt.Errorf("field settlement_currency of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.exchange_rate":
		panic(fmt.Errorf("field exchange_rate of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.exchange":
		panic(fmt.Errorf("field exchange of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.fund_name":
		panic(fmt.Errorf("field fund_name of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.issuer":
	...
	case "vvtxchain.trade.TradeInfo.share_price":
		panic(fmt.Errorf("field share_price of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.ticker":
		panic(fmt.Errorf("field ticker of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.trade_fee":
		panic(fmt.Errorf("field trade_fee of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.share_net_price":
		panic(fmt.Errorf("field share_net_price of message vvtxchain.trade.TradeInfo is not mutable"))
	case "vvtxchain.trade.TradeInfo.trade_net_value":
		panic(fmt.Errorf("field trade_net_value of message vvtxchain.trade.TradeInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.TradeInfo"))
		}
...
func (x *fastReflection_TradeInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vvtxchain.trade.TradeInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_TradeInfo) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.ShareNetPrice != 0 || math.Signbit(x.ShareNetPrice) {
			n += 10
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.ShareNetPrice != 0 || math.Signbit(x.ShareNetPrice) {
			i -= 8
			binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(x.ShareNetPrice))))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x91
		...
		if x.NumberOfShares != 0 || math.Signbit(x.NumberOfShares) {
			i -= 8
			binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(x.NumberOfShares))))
			i--
			dAtA[i] = 0x59
		}
		if len(x.Issuer) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 11:
				if wireType != 1 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field NumberOfShares", wireType)
				}
				var v uint64
				if (iNdEx + 8) > l {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, io.ErrUnexpectedEOF
			...
			case 13:
				...
				if x.Quantity == nil {
					x.Quantity = &v1beta1.Coin{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Quantity); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 14:
			...
			case 18:
				if wireType != 1 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ShareNetPrice", wireType)
				}
				var v uint64
				if (iNdEx + 8) > l {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, io.ErrUnexpectedEOF
				...
				v = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
				iNdEx += 8
				x.ShareNetPrice = float64(math.Float64frombits(v))
			case 19:
				if wireType != 1 {
...
func init() {
	file_vvtxchain_trade_trade_data_proto_init()
	md_Brokerage = File_vvtxchain_trade_trade_data_proto.Messages().ByName("Brokerage")
...
func (x *Brokerage) slowProtoReflect() protoreflect.Message {
	mi := &file_vvtxchain_trade_trade_data_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Brokerage) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vvtxchain.trade.Brokerage.name":
		return x.Name != ""
	case "vvtxchain.trade.Brokerage.type":
		return x.Type_ != ""
	case "vvtxchain.trade.Brokerage.country":
		return x.Country != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.Brokerage"))
		}
		panic(fmt.Errorf("message vvtxchain.trade.Brokerage does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Brokerage) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vvtxchain.trade.Brokerage does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Brokerage) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vvtxchain.trade.Brokerage.name":
		panic(fmt.Errorf("field name of message vvtxchain.trade.Brokerage is not mutable"))
	case "vvtxchain.trade.Brokerage.type":
		panic(fmt.Errorf("field type of message vvtxchain.trade.Brokerage is not mutable"))
	case "vvtxchain.trade.Brokerage.country":
		panic(fmt.Errorf("field country of message vvtxchain.trade.Brokerage is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vvtxchain.trade.Brokerage"))
		}
...
func (x *fastReflection_Brokerage) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vvtxchain.trade.Brokerage", d.FullName()))
	}
	panic("unreachable")
}
...
func (*TradeData) Descriptor() ([]byte, []int) {
	return file_vvtxchain_trade_trade_data_proto_rawDescGZIP(), []int{0}
}
...
func (*TradeInfo) Descriptor() ([]byte, []int) {
	return file_vvtxchain_trade_trade_data_proto_rawDescGZIP(), []int{1}
}
...
func (x *TradeInfo) GetNumberOfShares() float64 {
	if x != nil {
...
func (x *TradeInfo) GetQuantity() *v1beta1.Coin {
	if x != nil {
		return x.Quantity
	}
	return nil
...
func (x *TradeInfo) GetShareNetPrice() float64 {
	if x != nil {
		return x.ShareNetPrice
	}
	return 0
}
...
func (*Brokerage) Descriptor() ([]byte, []int) {
	return file_vvtxchain_trade_trade_data_proto_rawDescGZIP(), []int{2}
}
...
var File_vvtxchain_trade_trade_data_proto protoreflect.FileDescriptor

var file_vvtxchain_trade_trade_data_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x22, 0xcc, 0x05, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x64, 0x65, 0x49, 0x6e, 0x66,
	...
	,
...
var (
	file_vvtxchain_trade_trade_data_proto_rawDescOnce sync.Once
	file_vvtxchain_trade_trade_data_proto_rawDescData = file_vvtxchain_trade_trade_data_proto_rawDesc
)

func file_vvtxchain_trade_trade_data_proto_rawDescGZIP() []byte {
	file_vvtxchain_trade_trade_data_proto_rawDescOnce.Do(func() {
		file_vvtxchain_trade_trade_data_proto_rawDescData = protoimpl.X.CompressGZIP(file_vvtxchain_trade_trade_data_proto_rawDescData)
	})
	return file_vvtxchain_trade_trade_data_proto_rawDescData
}

var file_vvtxchain_trade_trade_data_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_vvtxchain_trade_trade_data_proto_goTypes = []interface{}{
	(*TradeData)(nil),    // 0: vvtxchain.trade.TradeData
	(*TradeInfo)(nil),    // 1: vvtxchain.trade.TradeInfo
	(*Brokerage)(nil),    // 2: vvtxchain.trade.Brokerage
	(TradeType)(0),       // 3: vvtxchain.trade.TradeType
	(*v1beta1.Coin)(nil), // 4: cosmos.base.v1beta1.Coin
}
var file_vvtxchain_trade_trade_data_proto_depIdxs = []int32{
	1, // 0: vvtxchain.trade.TradeData.trade_info:type_name -> vvtxchain.trade.TradeInfo
	2, // 1: vvtxchain.trade.TradeData.brokerage:type_name -> vvtxchain.trade.Brokerage
	3, // 2: vvtxchain.trade.TradeInfo.trade_type:type_name -> vvtxchain.trade.TradeType
	4, // 3: vvtxchain.trade.TradeInfo.quantity:type_name -> cosmos.base.v1beta1.Coin
...
func init() { file_vvtxchain_trade_trade_data_proto_init() }
func file_vvtxchain_trade_trade_data_proto_init() {
	if File_vvtxchain_trade_trade_data_proto != nil {
		return
	}
	file_vvtxchain_trade_trade_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_vvtxchain_trade_trade_data_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vvtxchain_trade_trade_data_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vvtxchain_trade_trade_data_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vvtxchain_trade_trade_data_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vvtxchain_trade_trade_data_proto_goTypes,
		DependencyIndexes: file_vvtxchain_trade_trade_data_proto_depIdxs,
		MessageInfos:      file_vvtxchain_trade_trade_data_proto_msgTypes,
	}.Build()
	File_vvtxchain_trade_trade_data_proto = out.File
	file_vvtxchain_trade_trade_data_proto_rawDesc = nil
	file_vvtxchain_trade_trade_data_proto_goTypes = nil
	file_vvtxchain_trade_trade_data_proto_depIdxs = nil
}
