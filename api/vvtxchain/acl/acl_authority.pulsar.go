...
func (x *AclAuthority) slowProtoReflect() protoreflect.Message {
	mi := &file_vvtxchain_acl_acl_authority_proto_msgTypes[0]
...
func (x *fastReflection_AclAuthority) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message vvtxchain.acl.AclAuthority does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AclAuthority) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vvtxchain.acl.AclAuthority does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AclAuthority) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vvtxchain.acl.AclAuthority", d.FullName()))
	}
	panic("unreachable")
}
...
func (*AclAuthority) Descriptor() ([]byte, []int) {
	return file_vvtxchain_acl_acl_authority_proto_rawDescGZIP(), []int{0}
}
...
var file_vvtxchain_acl_acl_authority_proto_rawDesc = []byte{
	...
	0x63, 0x6c, 0x1a, 0x25, 0x67, 0x67, 0x65, 0x7a, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x61, 0x63,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x67, 0x67, 0x65, 0x7a, 0x63, 0x68, 0x61, 0x69, 0x6e,
	...
	0x2e, 0x67, 0x67, 0x65, 0x7a, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x61, 0x63, 0x6c, 0x42, 0x11,
	...
	0x69, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x67, 0x65, 0x7a, 0x63, 0x68, 0x61, 0x69, 0x6e,
	0x2f, 0x61, 0x63, 0x6c, 0xa2, 0x02, 0x03, 0x47, 0x41, 0x58, 0xaa, 0x02, 0x0d, 0x47, 0x67, 0x65,
	0x7a, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x41, 0x63, 0x6c, 0xca, 0x02, 0x0d, 0x47, 0x67, 0x65,
	0x7a, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5c, 0x41, 0x63, 0x6c, 0xe2, 0x02, 0x19, 0x47, 0x67, 0x65,
	0x7a, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5c, 0x41, 0x63, 0x6c, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0e, 0x47, 0x67, 0x65, 0x7a, 0x63, 0x68, 0x61,
	0x69, 0x6e, 0x3a, 0x3a, 0x41, 0x63, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_vvtxchain_acl_acl_authority_proto_rawDescOnce sync.Once
	file_vvtxchain_acl_acl_authority_proto_rawDescData = file_vvtxchain_acl_acl_authority_proto_rawDesc
)

func file_vvtxchain_acl_acl_authority_proto_rawDescGZIP() []byte {
	file_vvtxchain_acl_acl_authority_proto_rawDescOnce.Do(func() {
		file_vvtxchain_acl_acl_authority_proto_rawDescData = protoimpl.X.CompressGZIP(file_vvtxchain_acl_acl_authority_proto_rawDescData)
	})
	return file_vvtxchain_acl_acl_authority_proto_rawDescData
}
...
func file_vvtxchain_acl_acl_authority_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vvtxchain_acl_acl_authority_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vvtxchain_acl_acl_authority_proto_goTypes,
		DependencyIndexes: file_vvtxchain_acl_acl_authority_proto_depIdxs,
		MessageInfos:      file_vvtxchain_acl_acl_authority_proto_msgTypes,
	}.Build()
	File_vvtxchain_acl_acl_authority_proto = out.File
	file_vvtxchain_acl_acl_authority_proto_rawDesc = nil
	file_vvtxchain_acl_acl_authority_proto_goTypes = nil
	file_vvtxchain_acl_acl_authority_proto_depIdxs = nil
}
