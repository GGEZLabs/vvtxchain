...
var (
	...
	fd_QueryGetAclAdminResponse_acl_admin protoreflect.FieldDescriptor
)

func init() {
	file_vvtxchain_acl_query_proto_init()
	md_QueryGetAclAdminResponse = File_vvtxchain_acl_query_proto.Messages().ByName("QueryGetAclAdminResponse")
	fd_QueryGetAclAdminResponse_acl_admin = md_QueryGetAclAdminResponse.Fields().ByName("acl_admin")
}
...
func (x *fastReflection_QueryGetAclAdminResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AclAdmin != nil {
		...
		if !f(fd_QueryGetAclAdminResponse_acl_admin, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryGetAclAdminResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vvtxchain.acl.QueryGetAclAdminResponse.acl_admin":
...
var (
	...
	fd_QueryAllAclAdminResponse_acl_admin  protoreflect.FieldDescriptor
...
func init() {
	...
	fd_QueryAllAclAdminResponse_acl_admin = md_QueryAllAclAdminResponse.Fields().ByName("acl_admin")
...
func (x *fastReflection_QueryAllAclAdminResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.AclAdmin) != 0 {
		...
		if !f(fd_QueryAllAclAdminResponse_acl_admin, value) {
			return
		}
	}
	if x.Pagination != nil {
...
func (x *fastReflection_QueryAllAclAdminResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vvtxchain.acl.QueryAllAclAdminResponse.acl_admin":
...
type QueryGetAclAuthorityResponse struct {
	...
	AclAuthority *AclAuthority `protobuf:"bytes,1,opt,name=acl_authority,json=aclAuthority,proto3" json:"acl_authority,omitempty"`
}
...
type QueryAllAclAuthorityResponse struct {
	...
	AclAuthority []*AclAuthority       `protobuf:"bytes,1,rep,name=acl_authority,json=aclAuthority,proto3" json:"acl_authority,omitempty"`
