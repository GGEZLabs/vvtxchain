...
func (*SuperAdmin) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd7f510928c1650e, []int{0}
}
...
func init() {
	proto.RegisterType((*SuperAdmin)(nil), "vvtxchain.acl.SuperAdmin")
}

func init() { proto.RegisterFile("vvtxchain/acl/super_admin.proto", fileDescriptor_cd7f510928c1650e) }

var fileDescriptor_cd7f510928c1650e = []byte{
	// 155 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2f, 0x2b, 0x2b, 0xa9,
	0x48, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x4f, 0x4c, 0xce, 0xd1, 0x2f, 0x2e, 0x2d, 0x48, 0x2d, 0x8a,
	0x4f, 0x4c, 0xc9, 0xcd, 0xcc, 0xd3, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x85, 0x2b, 0xd0,
	0x4b, 0x4c, 0xce, 0x51, 0x52, 0xe2, 0xe2, 0x0a, 0x06, 0xa9, 0x71, 0x04, 0x29, 0x11, 0x12, 0xe1,
	0x62, 0x05, 0xab, 0x95, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0x70, 0x9c, 0x9c, 0x4f, 0x3c,
	...
	0x2f, 0x39, 0x3f, 0x57, 0xdf, 0xdd, 0xdd, 0x35, 0xca, 0x27, 0x31, 0xa9, 0x58, 0x1f, 0xe1, 0x82,
	0x0a, 0xb0, 0x1b, 0x4a, 0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xd6, 0x1b, 0x03, 0x02, 0x00,
	0x00, 0xff, 0xff, 0x1e, 0x0d, 0xd1, 0x7f, 0xa1, 0x00, 0x00, 0x00,
}
...
func (m *SuperAdmin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Admin) > 0 {
		i -= len(m.Admin)
		copy(dAtA[i:], m.Admin)
		i = encodeVarintSuperAdmin(dAtA, i, uint64(len(m.Admin)))
		i--
		dAtA[i] = 0xa
	}
