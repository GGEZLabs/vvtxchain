...
The `x/acl` module provides an Access Control List for the vvtxchain network.
...
```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L20
```

```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L46-L50
```
...
```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L21
```

```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L54-L58
```
...
```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L22
```

```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L62-L66
```
...
```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L23
```

```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L70-L74
```
...
```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L24
```

```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L78-L84
```
...
```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L25
```

```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L88-L98
```
...
```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L26
```

```protobuf reference
https://github.com/GGEZLabs/vvtxchain/blob/main/proto/vvtxchain/acl/tx.proto#L102-L106
```
...
```shell
vvtxchaind query acl super-admin [flags]
```

Example:

```shell
vvtxchaind query acl super-admin
```
...
```shell
vvtxchaind query acl admins [flags]
```

Example:

```shell
vvtxchaind query acl admins
```
...
```yml
acl_admin:
- address: vvtx16a37gfhdfh5temrf3s43qwdsulpp0c58e2t5ny
pagination:
  total: "1"
```
...
```shell
vvtxchaind query acl admin [address] [flags]
```

Example:

```shell
vvtxchaind query acl admin vvtx...
```
...
```shell
vvtxchaind query acl acl-authorities [flags]
```

Example:

```shell
vvtxchaind query acl acl-authorities
```
...
```shell
vvtxchaind query acl acl-authority [address] [flags]
```

Example:

```shell
vvtxchaind query acl acl-authority vvtx...
```
...
```shell
vvtxchaind tx acl init [super-admin] [flags]
```

Example:

```shell
vvtxchaind tx acl init vvtx...
```
...
```shell
vvtxchaind tx acl update-super-admin [new-super-admin] [flags]
```

Example:

```shell
vvtxchaind tx acl update-super-admin vvtx...
```
...
```shell
vvtxchaind tx acl add-admin [admins] [flags]
```

Example:

```shell
vvtxchaind tx acl add-admin vvtx...,vvtx...
```
...
```shell
vvtxchaind tx acl delete-admin [admins] [flags]
```

Example:

```shell
vvtxchaind tx acl delete-admin vvtx...,vvtx...
```
...
```shell
vvtxchaind tx acl add-authority [auth-address] [name] [access-definitions] [flags]
```

Example:

```shell
vvtxchaind tx acl add-authority vvtx... Alice '[{"module":"trade","is_maker":true,"is_checker":false}]'
```
...
```shell
vvtxchaind tx acl update-authority [auth-address] [name] [access-definitions] [flags]
```

Example:

```shell
vvtxchaind tx acl update-authority vvtx... Alice '[{"module":"trade","is_maker":true,"is_checker":false}]'
```
