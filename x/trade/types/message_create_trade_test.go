	...
	tests := []struct {
		...
		},
		{
			...
			msg: MsgCreateTrade{
				Creator:         sample.AccAddress(),
				ReceiverAddress: sample.AccAddress(),
				TradeData:       `"trade_data":{"asset_holder_id":1,"asset_id":1,"trade_type":1,"trade_value":1944.9,"base_currency":"GBP","settlement_currency":"GBP","exchange_rate":1,"exchange":"US","fund_name":"Low Carbon Target ETF","issuer":"Blackrock","number_of_shares":10,"coin_minting_price":0.000000000012,"quantity":{"amount":"162075000000000","denom":"ugbpv"},"segment":"Equity: Global Low Carbon","share_price":194.49,"ticker":"CRBN","trade_fee":0,"share_net_price":194.49,"trade_net_value":1944.9},"brokerage":{"name":"Interactive Brokers LLC","type":"Brokerage Firm","country":"US"}}`,
			},
